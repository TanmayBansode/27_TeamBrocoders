...
export default function Dashboard() {
  ...
  const addWidget = () => {
    if (newWidgetTitle.trim() !== '') {
      setWidgets([...widgets, { id: `widget-${Date.now()}`, title: newWidgetTitle }])
      setNewWidgetTitle('')
    }
  }
                              ...
                              {widget.id === 'recent-activity' && (
                                <div className="space-y-2">
                                  ...
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <span>Committed 3 files to project-x</span>
                                  </div>
                                  <div className="flex items-center space-x-2">
                                ...
                                <div className="h-[200px]">
                                  <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={activityData}>
                                      ...
                                      <Bar dataKey="codeReviews" fill="#ffc658" />
                                    </BarChart>
                                  </ResponsiveContainer>
                                </div>
                              )}
